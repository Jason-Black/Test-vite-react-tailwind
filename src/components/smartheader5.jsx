  ...
  useGSAP(() => {
    ...
    const handleScroll = () => {
      ...
      if (scrollTop > currentScroll && scrollTop > 250) {
        // Scrolling down after reaching sticky point, hide the header smoothly
        gsap.to(header, {
          y: '-100%',
          ease: 'power1.out',
          duration: 0.5,
        });
      } else if (scrollTop > currentScroll) {
        // Scrolling down before sticky point, move the header off the screen normally
